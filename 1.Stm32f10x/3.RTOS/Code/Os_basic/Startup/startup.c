...
//#include <stdint.h>
//
//#define _sRAM       0x20000000U
//#define _size_RAM   (20U * 1024U)
//#define _eRAM       ((_sRAM) + (_size_RAM))
//
...
//
//void Reset_Handler(void){
//     /* 1. Sao chép dữ liệu từ Flash (vùng .data LMA) vào RAM (vùng .data VMA) */
...
//    }
//
//    /* 2. Khởi tạo vùng .bss với giá trị 0 */
